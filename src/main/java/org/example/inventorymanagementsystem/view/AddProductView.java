...
import org.example.inventorymanagementsystem.controller.AddProductController;
import org.example.inventorymanagementsystem.model.Inventory;
import org.example.inventorymanagementsystem.model.Part;

public class AddProductView extends Stage {
    ...
    public AddProductView() {
        ...
        // Auto-generate product ID (for demo)
        int autoId = Inventory.getAllProducts().size() + 1001;
        ...
        associatedPartsTable.setItems(FXCollections.observableArrayList());
